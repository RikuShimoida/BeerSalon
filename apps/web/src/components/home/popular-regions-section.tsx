...
type PopularRegionsSectionProps = {
	title: string;
				...
				{regions.map((region) => (
					...
					>
						...
						<div className="absolute top-4 left-4">
							<span
								className={`inline-flex items-center justify-center w-10 h-10 rounded-full text-lg font-bold ${getRankBadgeColor(region.rank)} shadow-lg`}
							>
								{region.rank}
							</span>
						</div>
