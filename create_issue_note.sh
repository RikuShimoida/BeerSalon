...
# 5. 課題
issue=$(read_multiline_required "★課題を入力してください:")
echo ""

# 6. 期待する状態
expected=$(read_multiline_required "★期待する状態を入力してください:")
echo ""

# 7. なぜそれをやるのか？
reason=$(read_multiline_required "★なぜそれをやるのか？を入力してください:")
echo ""
...
# 9. 受入条件
acceptance=$(read_multiline_required "★受入条件を入力してください:")
echo ""
...
read -p "この内容で課題管理表に追加しますか？ (y/n): " confirm
if [ "$confirm" != "y" ]; then
